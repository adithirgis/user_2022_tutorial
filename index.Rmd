...
## [GitHub](https://github.com/adithirgis/user_2022_tutorial)
## [Slides](https://user2022tutorial.netlify.app/)
## [Read Me / Notes / Questions](https://docs.google.com/document/d/1OZUgLioKxihOVatHHnrFTNQn5ySHwKEfYhZGZuHxf9w/edit#heading=h.inqydmvlzlfh) 
...
???
Earth is a 3D object and when we are making a map we need to represent this in 2-D form i.e. on a flat surface. This is called MAP proejctions. As you can see in the figure here. There aer several ways to do this. Think of keeping a paper either on the poles and project each point on that paper. Depending on how you project, your final map will be diferent. 
---
